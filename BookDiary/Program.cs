...
var connectionString = builder.Configuration.GetConnectionString("ArsenalConnection") ?? throw new InvalidOperationException("Connection string 'DefaultConnection' not found.");
